...
function SlotMachine() {
  ...
  const canSpin = useCallback(() => {
    return !showSpinningWheel &&
      ...
      !isAnimating &&
      !cooldownActive;
  }, [showSpinningWheel, freeSpins, gems, isSpinning, isAnimating, cooldownActive, betMultiplier]);
  ...
  if (winningCombos.length > 0) {
    ...
    const totalMultiplier = betMultiplier === 1 
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {isSpinning || isAnimating || cooldownActive ? (
                      ...
                      freeSpins > 0 ? `FREE SPIN (${freeSpins} left)` : `PLAY (${getCurrentSpinCost()} gems)`
                    )}
                  </Button>
